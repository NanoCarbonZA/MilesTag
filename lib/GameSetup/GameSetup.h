...
/****************************************************************************************************************************************************************************************/
  ...
  enum class LAUNCHTRIGGER
  {
    TIMER,
    SPAWNPOINT,
    UNKNOWN_LAUNCHTRIGGER
  };
  static std::map<LAUNCHTRIGGER, String> LaunchTriggers = {
      {LAUNCHTRIGGER::TIMER, "TIMER"},
...
/****************************************************************************************************************************************************************************************/
  ...
  static std::map<DEVICETYPE, String> DeviceTypes = {
      {DEVICETYPE::VEST, "VEST"},
      {DEVICETYPE::WEAPON, "WEAPON"},
      {DEVICETYPE::BASE, "BASE"},
...
/****************************************************************************************************************************************************************************************/
  ...
  static std::map<WEAPONTYPE, String> WeaponTypesMap = {
...
/****************************************************************************************************************************************************************************************/
  ...
  static std::map<PLAYERSTATE, String> PlayerStates = {
      {PLAYERSTATE::DETACHED, "DETACHED"},
...
/****************************************************************************************************************************************************************************************/
  ...
  struct GameSetup
  {
    ...
    GameSetup(GAMEMODES _gameMode, GAMESTATE _gameState, uint32_t _gameStartTime, bool _teamBased, uint32_t _teams, bool _friendlyFire, uint32_t _playerCount, std::map<uint32_t, Player> _players, LAUNCHTRIGGER _launchTrigger, uint32_t _launchTime, STOPTRIGGER _stopTrigger, uint32_t _stopLimit, uint32_t _killMultiplier, uint32_t _assistMultiplier, uint32_t _gameModePoints, uint32_t _conquestPoints, bool _extendedUpdates)
        : gameMode(_gameMode), gameState(_gameState), gameStartTime(_gameStartTime), teamBased(_teamBased), teams(_teams), friendlyFire(_friendlyFire), playerCount(_playerCount), players(_players), launchTrigger(_launchTrigger), launchTime(_launchTime), stopTrigger(_stopTrigger), stopLimit(_stopLimit), killMultiplier(_killMultiplier), assistMultiplier(_assistMultiplier), gameModePoints(_gameModePoints), conquestPoints(_conquestPoints), extendedUpdates(_extendedUpdates) {}

    GameSetup(GAMEMODES _gameMode, GAMESTATE _gameState, bool _teamBased, uint32_t _teams, bool _friendlyFire, uint32_t _playerCount, std::map<uint32_t, Player> _players,
              LAUNCHTRIGGER _launchTrigger, uint32_t _launchTime, STOPTRIGGER _stopTrigger, uint32_t _stopLimit)
        : gameMode(GAMEMODES::FREE_FOR_ALL), gameState(GAMESTATE::SETUP), gameStartTime(0), teamBased(false), teams(2), friendlyFire(false), playerCount(0), players({}),
